    ...
    <main className="min-h-screen bg-[#F0FAFB]">
      ...
      <div className="bg-[#0F3A42] px-4 py-3">
        <div className="flex justify-between items-center">
          <div>
            <div className="text-white font-bold text-lg tracking-wide">Gerencia</div>
            <div className="text-[#7ADCE8] text-xs mt-0.5">Vista ejecutiva · {perfil.nombre}</div>
          </div>
          <div className="bg-[#1ABBD6] text-white text-xs font-bold px-3 py-1 rounded-full tracking-wide uppercase">GER</div>
        </div>
      </div>
      ...
      <div className="px-4 pt-3">
        ...
        <div className="bg-[#FCEBEB] border border-[#F09595] rounded-xl px-3 py-2 flex gap-2 items-start mb-3">
          <div className="w-2 h-2 rounded-full bg-[#E24B4A] mt-1 flex-shrink-0"></div>
          <div className="text-[#A32D2D] text-xs leading-relaxed">
            <span className="font-bold">2 luminarias</span> sin respuesta +30 min · Turno mañana en atención
          </div>
        </div>
        ...
        <div className="bg-white border border-[#B2E0E8] rounded-xl p-3 mb-2">
          <div className="flex justify-between items-center">
            <div>
              <div className="text-[#0F3A42] font-bold text-sm">Semana 16</div>
              <div className="text-[#7A9EA5] text-xs mt-0.5">47 órdenes · 3 alertas · 0 accidentes</div>
            </div>
        ...
        <div className="bg-white border border-[#B2E0E8] rounded-xl p-3 mb-24">
          <div className="flex justify-between items-center">
            <div>
              <div className="text-[#0F3A42] font-bold text-sm">Consumo stock · Abril</div>
              <div className="text-[#7A9EA5] text-xs mt-0.5">LED 150W: 38u · Fusibles: 12u</div>
            </div>

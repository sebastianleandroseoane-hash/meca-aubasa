    ...
    <main className="min-h-screen bg-[#F0FAFB]">
      ...
      <div className="bg-[#0F3A42] px-4 py-3">
        <div className="flex justify-between items-center">
          <div>
            <div className="text-white font-bold text-lg tracking-wide">Buen día, Sebastián</div>
            <div className="text-[#7ADCE8] text-xs mt-0.5">Técnico · Turno mañana 07–15</div>
          </div>
          <div className="bg-[#1ABBD6] text-white text-xs font-bold px-3 py-1 rounded-full tracking-wide">07–15</div>
        </div>
      </div>

      {/* ALERTA */}
      <div className="px-4 pt-3">
        <div className="bg-[#FCEBEB] border border-[#F09595] rounded-xl px-3 py-2 flex gap-2 items-start">
      ...
      <div className="px-4 pt-3 pb-24">
        ...
        <div className="bg-white border border-[#B2E0E8] rounded-xl p-3 flex justify-between items-center">
          <div>

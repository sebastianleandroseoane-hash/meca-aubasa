    ...
    <main className="min-h-screen bg-[#F0FAFB]">
      <div className="bg-[#0F3A42] px-4 py-3">
        <div className="flex justify-between items-center">
          <div>
            <div className="text-white font-bold text-lg tracking-wide">Técnico Edificios</div>
            <div className="text-[#7ADCE8] text-xs mt-0.5">{perfil.nombre} · Turno {perfil.turno}</div>
          </div>
          <div className="bg-[#0A2830] text-[#7ADCE8] text-xs font-bold px-3 py-1 rounded-full tracking-wide uppercase">TÉC·EDIF</div>
        </div>
      </div>
      ...
      <div className="px-4 pt-3">
        ...
        {ordenActiva && (
          <>
            ...
            <div onClick={() => abrirDetalle(ordenActiva)} className="bg-white border border-[#B2E0E8] rounded-xl p-3 mb-3 cursor-pointer active:bg-[#F0FAFB]">
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  <div className="text-[#7A9EA5] text-xs">OT-{String(ordenActiva.numero_orden).padStart(5, '0')}</div>
                  <div className="text-[#0F3A42] font-bold text-sm">{ordenActiva.titulo}</div>
                  {ordenActiva.ubicacion && <div className="text-[#7A9EA5] text-xs mt-0.5">{ordenActiva.ubicacion}</div>}
                </div>
        ...
        <div className="text-[#7A9EA5] text-xs font-bold tracking-widest uppercase mb-2">
          Mis órdenes · {ordenes.length} total
        </div>

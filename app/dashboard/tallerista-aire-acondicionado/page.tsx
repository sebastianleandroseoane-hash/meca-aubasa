...
export default function DashboardTalleristaAC() {
  ...
  useEffect(() => {
    getPerfil().then(p => {
      ...
      if (p.rol !== 'tallerista_ac' && p.rol !== 'superadmin' && p.rol !== 'jefe') { router.push('/'); return }
      setPerfil(p)
    })
  }, [])
    ...
    <main className="min-h-screen bg-[#F0FAFB]">
      <div className="bg-[#0F3A42] px-4 py-3">
        <div className="flex justify-between items-center">
          <div>
            ...
            <div className="text-[#7ADCE8] text-xs mt-0.5">Tallerista Aire Acondicionado</div>
          </div>
          <div className="bg-[#1ABBD6] text-white text-xs font-bold px-3 py-1 rounded-full tracking-wide uppercase">TALL·AC</div>
        </div>
      </div>
      ...
      <div className="px-4 pt-3">
        ...
        <div className="grid grid-cols-2 gap-2 mb-3">
          ...
          <div className="bg-white border border-[#B2E0E8] rounded-xl p-3">
            <div className="text-[#3B6D11] font-bold text-2xl">1</div>
        ...
        <div className="bg-white border border-[#B2E0E8] rounded-xl p-3 mb-2 flex justify-between items-center">
          <div>
            <div className="text-[#0F3A42] font-bold text-sm">Compresor Split · Km 45</div>
            <div className="text-[#7A9EA5] text-xs mt-0.5">Revisión y carga de gas</div>
          </div>
          <span className="bg-[#FAEEDA] text-[#854F0B] text-xs font-bold px-2 py-0.5 rounded-full">En curso</span>
        </div>
        <div className="bg-white border border-[#B2E0E8] rounded-xl p-3 mb-2 flex justify-between items-center">
          <div>
            <div className="text-[#0F3A42] font-bold text-sm">Placa electrónica · Ref. 112</div>
            <div className="text-[#7A9EA5] text-xs mt-0.5">Sin repuesto — pedido realizado</div>
          </div>
          <span className="bg-[#FCEBEB] text-[#A32D2D] text-xs font-bold px-2 py-0.5 rounded-full">Sin repuesto</span>
        </div>

        <div className="text-[#7A9EA5] text-xs font-bold tracking-widest uppercase mb-2">Stock insumos AC</div>
        <div className="bg-white border border-[#B2E0E8] rounded-xl p-3 mb-2 flex justify-between items-center">
          <div>
            <div className="text-[#0F3A42] font-bold text-sm">Gas refrigerante R-410A</div>
            <div className="text-[#7A9EA5] text-xs mt-0.5">2 kg disponibles</div>
          </div>
        ...
        <div className="bg-white border border-[#B2E0E8] rounded-xl p-3 mb-24 flex justify-between items-center">
          <div>
            <div className="text-[#0F3A42] font-bold text-sm">Filtros de aire</div>
            <div className="text-[#7A9EA5] text-xs mt-0.5">12 unidades</div>
          </div>

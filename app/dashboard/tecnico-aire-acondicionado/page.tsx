  ...
  return (
    <main className="min-h-screen bg-[#F0FAFB]">
      <div className="bg-[#0F3A42] px-4 py-3">
        <div className="flex justify-between items-center">
          <div>
            ...
            <div className="text-[#7ADCE8] text-xs mt-0.5">Técnico Aire Acondicionado · Turno {perfil.turno}</div>
          </div>
          <div className="bg-[#1ABBD6] text-white text-xs font-bold px-3 py-1 rounded-full tracking-wide uppercase">AC</div>
        </div>
      </div>
      ...
      <div className="px-4 pt-3">
        ...
        <div className="bg-white border border-[#B2E0E8] rounded-xl p-3 mb-3">
          <div className="flex justify-between items-start">
            <div>
              <div className="text-[#0F3A42] font-bold text-sm">Mantenimiento Split · Cabina km 12</div>
              <div className="text-[#7A9EA5] text-xs mt-0.5">Limpieza filtros + carga gas</div>
            </div>
          ...
          <div className="bg-[#E8F4F7] rounded-full h-1.5 mt-3 overflow-hidden">
            <div className="bg-[#1ABBD6] h-full rounded-full" style={{width:'50%'}}></div>
          </div>
          <div className="text-[#7A9EA5] text-xs mt-1">2 de 4 puntos completados</div>
        </div>

        <div className="text-[#7A9EA5] text-xs font-bold tracking-widest uppercase mb-2">Equipos a revisar hoy</div>
        <div className="bg-white border border-[#B2E0E8] rounded-xl p-3 mb-2 flex justify-between items-center">
          <div>
            <div className="text-[#0F3A42] font-bold text-sm">Split Cabina · Km 12</div>
            <div className="text-[#7A9EA5] text-xs mt-0.5">Mantenimiento preventivo</div>
          </div>
          <span className="bg-[#FAEEDA] text-[#854F0B] text-xs font-bold px-2 py-0.5 rounded-full">En curso</span>
        </div>
        <div className="bg-white border border-[#B2E0E8] rounded-xl p-3 mb-2 flex justify-between items-center">
          <div>
            <div className="text-[#0F3A42] font-bold text-sm">Split Cabina · Km 28</div>
            <div className="text-[#7A9EA5] text-xs mt-0.5">Revisión compresor</div>
          </div>
        ...
        <div className="bg-white border border-[#B2E0E8] rounded-xl p-3 mb-24">
          <div className="text-[#0F3A42] font-bold text-sm">Informe 22–06 · Rodríguez</div>
          <div className="text-[#7A9EA5] text-xs mt-0.5">3 equipos OK · Split km 45 sin gas</div>
        </div>
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#0F3A42] border-t border-[#1A4A54] flex justify-around py-2">
        ...
        <div className="flex flex-col items-center gap-0.5 cursor-pointer">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#7ADCE8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 4v3a1 1 0 0 1-1 1H5"/><path d="M4 20h16a2 2 0 0 0 2-2V8l-6-4H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2z"/></svg>
          <span className="text-[#7ADCE8] text-xs">Equipos</span>
        </div>
        <div className="flex flex-col items-center gap-0.5 cursor-pointer">
